...
# ------------------------------------------------------------------------------- #
export SAVE_PATH=$1 # /workspace/checkpoints/llama2-7b-test
export DATA_PATH=$2 # ./data_generation/output/alpaca/simple_rank/rank_1k.json
num_resp=$3
strategy=rank
use_eos_token=0
...
dataset=esnli
weight=0.1
export MODEL_PATH=NousResearch/Llama-2-7b-hf
